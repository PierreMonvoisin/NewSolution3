<ul id="default" class="list-group shadow">
  ...
  <li class="TopRight list-group-item list-group-item-success text-right main_font_color">
    Afin de vous améliorer et diminuer vos temps de résolution, vous pouvez approfondir vos connaissances avec ces conseils et algorithms simples.<br>D’autres méthodes de résolutions, des exemples illustrés et des listes d’algorithmes disponibles pour vous entraîner et apprendre autant que vous voulez.
  </li>
